...
static func register_cards():
	...
	CardDB.add_card(BT9_001_B.new())
	CardDB.add_card(BT9_002.new())
	CardDB.add_card(BT9_002_B.new())
	CardDB.add_card(BT9_003.new())
	CardDB.add_card(BT9_003_B.new())
	CardDB.add_card(BT9_004.new())
	CardDB.add_card(BT9_004_B.new())
	CardDB.add_card(BT9_005.new())
	CardDB.add_card(BT9_005_B.new())
	CardDB.add_card(BT9_006.new())
	CardDB.add_card(BT9_006_B.new())
	CardDB.add_card(BT9_007.new())
	CardDB.add_card(BT9_008.new())
	CardDB.add_card(BT9_008_B.new())
	...
	CardDB.add_card(BT9_080_B.new())
	CardDB.add_card(BT9_081.new())
	CardDB.add_card(BT9_081_B.new())
	CardDB.add_card(BT9_082.new())
	CardDB.add_card(BT9_082_B.new())
	CardDB.add_card(BT9_083.new())
	CardDB.add_card(BT9_083_B.new())
	...
	CardDB.add_card(BT9_111_B.new())
	CardDB.add_card(BT9_112.new())
	CardDB.add_card(BT9_112_B.new())
...
class BT9_017_B extends Card:
	func _init():
		...
		is_parallel = true
		notes = "parallel promo Dukemon X Antibody"
...
class BT9_071 extends Card:
	func _init():
		...
		digimon_type = "Undead"
		power = 1000
		effect_text = "[On Play] Reveal the top 3 cards of your deck. Trash 1 card with [Undead] or [Dark Animal] in its traits among them and add 1 card with [Undead] or [Dark Animal] in its traits among them to your hand. Place the rest at the bottom of your deck in any order."
...
class BT9_081_B extends Card:
	func _init():
		...
		is_parallel = true
		notes = "parallel promo Death-X-DORUgoramon"
...
class BT9_083_B extends Card:
	func _init():
		...
		is_parallel = true
		notes = "parallel promo Omegamon: Merciful Mode"
...
class BT9_103 extends Card:
	func _init():
		...
		ruling = [
					...
					"Q: If this card was used previously and then the opponent uses an effect that reveals cards from security. What happens?",
					"A: The cards are not considered to be added back into security.",
]
