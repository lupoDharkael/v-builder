...
class BT8_059 extends Card:
	func _init():
		...
		ruling = [
					...
					"Q: Can my opponent digivolve with the effect of [BT7-051 RhinoKabuterimon] which changes the memory cost of the digivolution?",
					...
					"Q: Can my opponent digivolve into [BT7-040 Rasenmon] for an alternate digivolution cost?",
					"A: Yes, it does not ignore digivolution requirements.",
					"Q: If I use [BT9-098 Awakening of the Golden Knight] and my opponent has this card. Can I digivolve my [Magnamon] into [BT9-044 Magnamon (X Antibody)] because it fulfills the digivolution requirements?",
