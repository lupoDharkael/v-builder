...
class EX2_023 extends Card:
	func _init():
		...
		ruling = [
					...
					"Q: Does the \"use an option card without paying cost\" effect trigger the inherited effect of this card when an option card with a use cost of 2 or more is used?",
					"A: Yes, the effect of \"using an option card without paying the cost\" still applies because the use cost has not changed.",
					"Q: If I have this Digimon in play, and use [EX2-070 Digivolution Plug-In S] to digivolve this Digimon into a Level 6 Digimon. Does this card's inherited [Your Turn] effect trigger?",
					"A: No, the effect was not active when the Option card was used.",
]

class EX2_023_B extends Card:
	func _init():
		name = "Taomon"
		type = Type.DIGIMON
		color = ColorGroup.YELLOW
...
class EX2_039 extends Card:
	func _init():
		...
		ruling = [
					...
					"Q: This Digimon has [BT2-007 Pagumon] in its digivolution cards, and declares an attack. The [When Attacking] inherited effect trashes another copy of this card. Does that Impmon's effect trigger?",
					"A: No, it was trashed by the effect of the top card which was a [EX2-039 Impmon].",
					"Q: This Digimon has [ST6-01 Pagumon] in its digivolution cards, and is deleted. The [On Deletion] inherited effect trashes another copy of this card. Does that Impmon's effect trigger?",
					"A: No, it was trashed by the effect of the top card which was a [EX2-039 Impmon].",
]
...
class EX2_045 extends Card:
	func _init():
		...
		ruling = [
					...
					"Q: I digivolve my Red Tamer into a Digimon with the effect of [BT4-011 Agunimon]. Can I suspend this card to gain 1 memory, <Draw 1>, and have 1 of my Digimon get +3000 DP for the turn?",
					"A: Yes, you can.",
]
		notes = "Culumon"
